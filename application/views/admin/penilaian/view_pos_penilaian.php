        ...
        <div class="box-body">
            <div class="table-responsive">
                ...
                <div class="col-md-12" style="padding: 0px">
                  <form id="form-juara" method="POST" action="<?php echo base_url() ?>penilaian/hasil_kejuaraan/post_juara">
                  <table class="table" style="border:0px;">
                    ...
                    <tr>
                      <th>Mata Lomba</th>
                      <td>
                          <input type="hidden" name="lomba" class="form-control" id="lomba" value="<?php echo $kegiatan->id ?>">
                          <input type="text" name="nmlomba" disabled class="form-control" id="nmlomba" value="<?php echo $lomba->nmlomba ?>">
                      </td>
                    </tr>
                    <tr class="hide">
              ...
              <div id="kejuaraan-box" class="col-md-12">
                  <table class="table">
                    <tr>
                  ...
                  <?php if($hasil_juara) :?>
                      <div class="alert alert-success" style="margin-top:20px;">Anda sudah menyimpan hasil kejuaraan, silahkan hubungi <b>MABES</b> jika ada perubahan.</div>
                  <?php else: ?>
