    ...
    <section class="content">
      <div class="box collapsed-box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Filter List User</h3>
          ...
          <form id="form-cari-pendaftaran">
            <table class="table table-responsive">
              ...
              <tr>
                ...
                <td  style="vertical-align: middle;">
                 <input type="text" name="nmsekolah" class="form-control">
                </td>
              </tr>
            </table>
          </form>
                    ...
                    <?php if($users): ?>
                      <?php  foreach($users as $key => $value):?>
                         <tr>
                          ...
                          <td class="text-center"><?php echo $value->default ?></td>
                          <td class="text-center"><?php echo $value->nmsekolah ?></td>
                        </tr>
                      <?php endforeach ?>
                    <?php else: ?>
                      <tr>
