      ...
      <?php
       ...
       <div class="box box-default">
          ...
          <div class="row box-body">
            <form id="form-pendaftaran" method="POST" action="<?php echo base_url() ?>pendaftaran/penggalang/post_smp">
              <div class="col-md-12">
                <table class="table table-striped table-responsive">
                  <tr>
                    <td width="15%">Jenjang</td>
                    <td>
                      Penggalang, Sekolah Menengah Pertama.
                    </th>
                  </tr>
                  <tr>
    ...
    function kecamatanChanges(){
      ...
      if(kecamatan){
        $('#warning-kecamatan').addClass('hide');
         //var kdProv = document.getElementById('provinsi').value;
       // alert(xx);
        var url = '<?php echo base_url()?>master/sekolah/get_api/'+kecamatan+'/'+2;
         //alert(v)
        $.ajax({
          //alert('test')
          url: url,
