...
<div style="margin-top: 40px;">
    ...
    <div class="col-md-12">
      <table align="center">
        <tr>
          ...
          <td><span class="title" style="font-size: 20pt">Hasil Kejuaraan Penggalang SMP<b><div>Jalakmas Championship 2020</div></b></span></td>
        </tr>
      </table>
    </div>   
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-12 text-center">
      <a href="<?php echo base_url()?>hasil_kejuaraan/detail_smp" class="btn btn-primary"><span class="glyphicon glyphicon-list"></span> Lihat Detail</a>
    </div>
  </div>
  </div>
