...
<!--Juklak-->
  <button class="accordion">Penggalang</button>
  <div class="panel">
    <embed src ="<?= base_url() ?>assets/jalakmas2020/juklakpenggalang.pdf" type ="application/pdf" width="100%" height= "800px"/>
  </div>
  <button class="accordion">Penegak</button>
  <div class="panel">
    <embed src ="<?= base_url() ?>assets/jalakmas2020/juklakpenegak.pdf" type ="application/pdf" width="100%" height= "800px"/>
  </div>
