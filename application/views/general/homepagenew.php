...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo welcome">
    <a href="<?php echo base_url()?>homepage/">Selamat Datang Di Portal Pendaftaran<div><b>Jalakmas Championship 2020</b></a></div>
  </div>
  <!-- User name -->
  ...
  <!-- /.lockscreen-item -->
  <a href="<?php echo base_url()?>homepage/penggalangsd"><button class="button"><span>Penggalang SD/MI </span></button></a>
  <a href="<?php echo base_url()?>homepage/penggalangsmp"><button class="button"><span>Penggalang SMP/MTs. </span></button></a>
  <a href="<?php echo base_url()?>homepage/penegakpandega"><button class="button"><span>Penegak/Pandega </span></button></a>
