...
<body>
  ...
  <div class="row" id="wrapper">
    <div class="col-md-12" >
      <div class="header-mata-lomba">
        <h2><b>Kejuaraan Penggalang SD/MI<div>Jalakmas Championship 2020</div></b></h2>
  ...
  <center><a href="<?php echo base_url() ?>hasil_kejuaraan/sd" class="btn btn-primary"> <i class="glyphicon glyphicon-arrow-left"></i> Kembali </a></center>
