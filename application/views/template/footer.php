 <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Designed By</b> Jalakmas Tech Tim
    </div>
...
<!-- Sparkline -->
<script src="<?php echo base_url('assets/js/bower_components') ?>/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/js/bower_components') ?>/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- <script src="<?php echo base_url('assets/js/dist') ?>/pages/dashboard.js"></script> -->
